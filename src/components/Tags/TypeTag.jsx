...
function TypeTag({type, typeDescription, icon}) {
  return (
    <Popover fontSize="sm" placement="top" isLazy trigger='hover'>
      <PopoverTrigger>
        <Center className="icon-container" borderRadius="4px" pt="5px" pb="5px" h="34px" pr="10px" pl="10px" bg="white" mb={2.5}> <span className="icon"><img src={icon} alt="" /></span> {type}</Center>
      </PopoverTrigger>
      <PopoverContent>
